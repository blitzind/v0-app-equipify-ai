...
export const GROWTH_AUTONOMY_CONTROL_CENTER_SUBTITLE =
  "Control how much Growth Engine can do on its own while keeping approvals and safety limits in place." as const
...
> = {
  manual: {
    ...
    safetyNote: "Safest default — Growth Engine only assists when you ask.",
  },
  assisted: {
    title: "Assisted",
...
export const GROWTH_AUTONOMY_KILL_SWITCH_OPERATOR_LABELS: Record<
  ...
  string
> = {
  autonomyEnabled: "Allow Growth Engine to act autonomously",
