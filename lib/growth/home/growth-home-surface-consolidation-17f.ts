...
export const GROWTH_HOME_SURFACE_SECTION_AUDIT: GrowthHomeSurfaceSectionAudit[] = [
  ...
  { id: "training-setup-cta", label: "Training setup CTA", kind: "setup_onboarding", primary: true },
  { id: "briefing-cross-links", label: "Briefing cross-links", kind: "canonical_home", primary: true },
  { id: "first-week-guide", label: "First-week guide", kind: "setup_onboarding", primary: true },
  { id: "ava-work", label: "Today's Work", kind: "canonical_home", primary: true },
  { id: "waiting-on-you", label: "What I need from you", kind: "canonical_home", primary: true },
  { id: "ava-memory", label: "What I've Learned", kind: "canonical_home", primary: true },
  { id: "get-ava-ready", label: "Get me ready", kind: "setup_onboarding", primary: false },
  { id: "ava-operating-rhythm", label: "Today's Progress", kind: "canonical_home", primary: false },
  { id: "executive-snapshot", label: "Where things stand", kind: "legacy_dashboard", primary: false },
  { id: "ava-research-loop", label: "Research loop", kind: "operational_tool", primary: false },
  { id: "research-growth-strategy", label: "Missions & outreach", kind: "legacy_dashboard", primary: false },
  ...
  { id: "start-ava-setup", label: "Get me ready (legacy)", kind: "setup_onboarding", primary: false },
