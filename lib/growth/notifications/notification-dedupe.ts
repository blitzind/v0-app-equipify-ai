...
export const GROWTH_NOTIFICATION_COOLDOWN_MINUTES: Partial<Record<GrowthNotificationType, number>> = {
  ...
  cadence_task_due: 30,
  cadence_task_overdue: 60,
  cadence_task_completed: 30,
  ...
  meeting_synced: 15,
  meeting_conflict: 30,
  deal_risk_increased: 120,
  high_probability_deal: 180,
...
export const GROWTH_NOTIFICATION_EXPIRY_MINUTES: Partial<Record<GrowthNotificationType, number>> = {
  ...
  cadence_task_due: 7 * 24 * 60,
  cadence_task_overdue: 3 * 24 * 60,
  cadence_task_completed: 7 * 24 * 60,
  ...
  deal_risk_increased: 7 * 24 * 60,
  high_probability_deal: 7 * 24 * 60,
