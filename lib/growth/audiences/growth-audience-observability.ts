...
import { countInProgressAudienceRefreshRuns } from "@/lib/growth/audiences/growth-audience-repository"
...
export async function getGrowthAudienceObservabilitySnapshot(
  ...
  try {
    ...
    return {
      ...
      rowsReadToday,
      rowsWrittenToday,
      failuresToday: failuresToday.count ?? 0,
      throttlesToday: throttlesToday.count ?? 0,
