...
export const GROWTH_MEDIA_AVATAR_PROVIDERS = ["elevenlabs"] as const
...
export function listEnabledMediaAvatars(
  ...
  return GROWTH_MEDIA_ELEVENLABS_AVATAR_CATALOG.filter(
...
export function getMediaAvatarById(avatarId: string | null | undefined): GrowthMediaAvatarDefinition | null {
  ...
  return GROWTH_MEDIA_ELEVENLABS_AVATAR_CATALOG.find((avatar) => avatar.avatarId === trimmed) ?? null
}
