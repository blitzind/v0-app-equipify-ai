...
const SIGNAL_RULES: SignalRule[] = [
  ...
  { signal: "pain_point_mentioned", patterns: [/struggling with/i, /problem with/i, /pain point/i, /challenge with/i, /frustrated/i], confidence: 0.7 },
  ...
  { signal: "decision_maker_clue", patterns: [/my (boss|manager|director|vp|ceo)/i, /decision maker/i, /procurement/i], confidence: 0.65 },
  { signal: "internal_referral", patterns: [/reach out to/i, /contact (my|our)/i, /speak with/i, /forward(ed)? this to/i], confidence: 0.6 },
