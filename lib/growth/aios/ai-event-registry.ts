...
export const AI_EVENT_REGISTRY: readonly AiEventRegistryEntry[] = [
  ...
  { eventType: "growth.company_intelligence.completed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Company Intelligence job completed — Draft Factory wake" },
  { eventType: "growth.datamoon.person_requested", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "DataMoon person discovery requested — async poll pending" },
  { eventType: "growth.datamoon.person_pending", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "DataMoon person discovery pending poll — Draft Factory wait" },
  { eventType: "growth.datamoon.person_completed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "DataMoon person enrichment completed — Draft Factory wake" },
  { eventType: "growth.datamoon.person_failed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "DataMoon person enrichment failed — Draft Factory wake" },
  { eventType: "growth.contact.verified", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Contact verification succeeded — Draft Factory wake" },
  { eventType: "growth.contact.available", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Provider contact available (unverified) — Draft Factory wake" },
  { eventType: "growth.contact.verification_failed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Contact verification failed — Draft Factory wake" },
  { eventType: "growth.personalization.completed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Personalization generation completed — Draft Factory wake" },
  { eventType: "growth.mission.changed", category: "mission", eventVersion: 1, schemaVersion: "1.0", description: "Mission/objective changed — Draft Factory wake" },
  { eventType: "growth.company.profile_changed", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Company/business profile changed — Draft Factory wake" },
  { eventType: "growth.capacity.available", category: "system", eventVersion: 1, schemaVersion: "1.0", description: "Capacity available for Draft Factory advancement" },
