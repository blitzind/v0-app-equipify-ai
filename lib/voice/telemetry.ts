...
export type VoiceTelemetryEvent =
  ...
  | "voice_inbound_schema_unavailable"
  | "voice_inbound_route_unresolved"
  | "voice_inbound_webhook_failed"
  | "voice_inbound_routing_timeout"
  | "voice_inbound_routing_bundle_step"
  | "voice_inbound_routing_bundle_timing"
  | "voice_inbound_browser_provision_failed"
  ...
  | "voice_browser_auth_source"
  | "voice_growth_coaching_link_pipeline_stage"
