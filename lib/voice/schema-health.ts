...
export const VOICE_SCHEMA_PROBE_VERSION = "v7" as const
export const VOICE_SCHEMA_MIGRATION_ID = "20270607120000_voice_conversation_intelligence_phase_2a" as const
