...
export const VOICE_SCHEMA_PROBE_VERSION = "v1" as const
export const VOICE_SCHEMA_MIGRATION_ID = "20270527140000_voice_infrastructure_foundation_phase_1a" as const
