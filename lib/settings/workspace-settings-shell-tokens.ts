...
/** Desktop settings nav — fixed width card shell (shared with Growth settings). */
export const WORKSPACE_SETTINGS_SHELL_SIDEBAR_DESKTOP = SETTINGS_NAV_SIDEBAR_CONTAINER
