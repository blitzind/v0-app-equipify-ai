...
/**
 * Workspace-wide list of AIden prepared actions (lifecycle, filters, detail drawer).
  ...
  if (!permissions.canViewInsights) {
    return (
      <div className="rounded-xl border border-dashed border-border bg-card px-6 py-12 text-center">
        <ListChecks className="mx-auto h-6 w-6 text-muted-foreground" aria-hidden />
        <h2 className="mt-3 text-sm font-semibold">AIden Action Center is restricted</h2>
        <p className="mx-auto mt-1 max-w-md text-xs leading-relaxed text-muted-foreground">
          Ask an owner, admin, or manager to grant you insights access to view prepared AIden actions for this
          workspace.
        </p>
      </div>
    )
