...
import { archiveArchivedRecord } from "@/lib/archived-center/archive-record"
...
export async function PATCH(request: Request) {
  try {
    ...
    const result = await archiveArchivedRecord(
      admin,
      gate.organizationId,
      recordTypeRaw,
      recordId,
    ...
    console.error("[PATCH /api/archived/archive]", e)
