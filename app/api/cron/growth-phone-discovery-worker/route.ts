...
import { processPhoneDiscoveryJobQueue } from "@/lib/growth/phone-discovery/phone-discovery-queue"
...
const CRON_ROUTE = growthCronApiPath("growth-phone-discovery-worker")
...
export async function POST(request: Request) {
  ...
  return runGrowthCronJob(
    ...
    async () => processPhoneDiscoveryJobQueue(admin),
  )
}
