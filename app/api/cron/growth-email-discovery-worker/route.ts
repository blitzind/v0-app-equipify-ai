...
import { processEmailDiscoveryJobQueue } from "@/lib/growth/email-discovery/email-discovery-queue"
...
const CRON_ROUTE = growthCronApiPath("growth-email-discovery-worker")
...
export async function POST(request: Request) {
  ...
  return runGrowthCronJob(
    ...
    async () => processEmailDiscoveryJobQueue(admin),
  )
}
