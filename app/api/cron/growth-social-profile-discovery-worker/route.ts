...
import { processSocialProfileDiscoveryJobQueue } from "@/lib/growth/social-profile-discovery/social-profile-discovery-queue"
...
const CRON_ROUTE = growthCronApiPath("growth-social-profile-discovery-worker")
...
export async function POST(request: Request) {
  ...
  return runGrowthCronJob(
    ...
    async () => processSocialProfileDiscoveryJobQueue(admin),
  )
}
