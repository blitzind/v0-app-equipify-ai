...
import { publishGrowthSharePageOperatorPage } from "@/lib/growth/share-pages/growth-share-page-operator-actions-service"
import {
...
export async function POST(
  ...
  try {
    const result = await publishGrowthSharePageOperatorPage(access.admin, {
