...
import { approveGrowthSharePageOperatorDraft } from "@/lib/growth/share-pages/growth-share-page-operator-actions-service"
import {
...
export async function POST(
  ...
  try {
    const workspace = await approveGrowthSharePageOperatorDraft(access.admin, {
