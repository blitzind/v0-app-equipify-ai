...
import { duplicateGrowthSharePageOperatorPage } from "@/lib/growth/share-pages/growth-share-page-operator-actions-service"
import {
...
export async function POST(
  ...
  try {
    const result = await duplicateGrowthSharePageOperatorPage(access.admin, {
    ...
    return NextResponse.json(
      growthSharePageWorkspaceSafetyJson({
        ...
        duplicate_page_id: result.duplicatePageId,
