...
import { archiveGrowthSharePageOperatorPage } from "@/lib/growth/share-pages/growth-share-page-operator-actions-service"
import {
...
export async function POST(
  ...
  try {
    const workspace = await archiveGrowthSharePageOperatorPage(access.admin, {
