...
import { retryGrowthAiAvatarGenerationJob } from "@/lib/growth/media/growth-ai-avatar-generation-service"
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const job = await retryGrowthAiAvatarGenerationJob(access.admin, {
