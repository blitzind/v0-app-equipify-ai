...
import { fetchBlitzpayPlatformCashAccountsRollup } from "@/lib/blitzpay/blitzpay-platform-cash-accounts-rollup"
...
export async function GET(request: Request) {
  ...
  try {
    const rollup = await fetchBlitzpayPlatformCashAccountsRollup(admin, { reportingWindowDays: windowDays })
