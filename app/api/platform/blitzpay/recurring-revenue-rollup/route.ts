...
import { fetchBlitzpayPlatformRecurringRevenueRollup } from "@/lib/blitzpay/blitzpay-platform-recurring-revenue-rollup"
...
export async function GET(request: Request) {
  ...
  try {
    const rollup = await fetchBlitzpayPlatformRecurringRevenueRollup(admin, { reportingWindowDays: windowDays })
