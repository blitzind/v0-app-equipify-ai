...
import { fetchBlitzpayPlatformCommandCenterRollup } from "@/lib/blitzpay/blitzpay-platform-command-center"
...
export async function GET(request: Request) {
  ...
  try {
    const rollup = await fetchBlitzpayPlatformCommandCenterRollup(admin, { reportingWindowDays: windowDays })
