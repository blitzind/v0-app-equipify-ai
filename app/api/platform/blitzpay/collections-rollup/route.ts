...
import { fetchBlitzpayPlatformCollectionsRollup } from "@/lib/blitzpay/blitzpay-platform-collections-rollup"
...
export async function GET(request: Request) {
  ...
  try {
    const rollup = await fetchBlitzpayPlatformCollectionsRollup(admin, { reportingWindowDays: windowDays })
