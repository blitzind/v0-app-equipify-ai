...
import { fetchBlitzpayPlatformPayrollRollup } from "@/lib/blitzpay/blitzpay-platform-payroll-rollup"
...
export async function GET(request: Request) {
  ...
  try {
    const rollup = await fetchBlitzpayPlatformPayrollRollup(admin, { reportingWindowDays: windowDays })
