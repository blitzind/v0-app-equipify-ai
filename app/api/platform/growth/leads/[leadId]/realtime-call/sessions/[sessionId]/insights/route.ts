...
import { getLiveCoachingSessionInsightsPayload } from "@/lib/growth/realtime/live-coaching/session-insights-service"
...
export async function GET(
  ...
  try {
    ...
    const insights = await getLiveCoachingSessionInsightsPayload(access.admin, { leadId, sessionId })
