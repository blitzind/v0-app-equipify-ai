...
import { pauseAutomationRuntime } from "@/lib/growth/automation/growth-automation-runtime-publisher-service"
...
export async function POST(
  ...
  try {
    const result = await pauseAutomationRuntime(access.admin, {
      flowId: id,
