...
import { advanceAutomationEnrollmentUntilBlocked } from "@/lib/growth/automation/growth-automation-runtime-orchestrator"
...
export async function POST(
  ...
  try {
    const execution = await advanceAutomationEnrollmentUntilBlocked(access.admin, {
      flowId: id,
