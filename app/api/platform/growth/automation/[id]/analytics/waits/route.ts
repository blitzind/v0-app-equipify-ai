...
import { getAutomationWaitAnalytics } from "@/lib/growth/automation/growth-automation-analytics-service"
...
export async function GET(
  ...
  try {
    const waits = await getAutomationWaitAnalytics(access.admin, {
      flowId: id,
