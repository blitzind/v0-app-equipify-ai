...
import { getAutomationBranchAnalytics } from "@/lib/growth/automation/growth-automation-analytics-service"
...
export async function GET(
  ...
  try {
    const branches = await getAutomationBranchAnalytics(access.admin, {
      flowId: id,
