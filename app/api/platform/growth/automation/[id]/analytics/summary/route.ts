...
import { getAutomationAnalyticsSummary } from "@/lib/growth/automation/growth-automation-analytics-service"
...
export async function GET(
  ...
  try {
    const summary = await getAutomationAnalyticsSummary(access.admin, {
      flowId: id,
