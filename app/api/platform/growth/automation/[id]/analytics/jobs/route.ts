...
import { getAutomationJobAnalytics } from "@/lib/growth/automation/growth-automation-analytics-service"
...
export async function GET(
  ...
  try {
    const jobs = await getAutomationJobAnalytics(access.admin, {
      flowId: id,
