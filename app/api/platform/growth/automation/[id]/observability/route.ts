...
import { getAutomationRuntimeObservability } from "@/lib/growth/automation/growth-automation-observability-service"
...
export async function GET(
  ...
  try {
    const observability = await getAutomationRuntimeObservability(access.admin, {
      flowId: id,
