...
import { pauseGovernancePolicy } from "@/lib/growth/governance/dashboard"
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  try {
    const policy = await pauseGovernancePolicy(access.admin, id, {
    ...
    return NextResponse.json({ error: "pause_failed", message }, { status: 500 })
  }
}
