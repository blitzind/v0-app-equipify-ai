...
import { runGrowthImportDryRun } from "@/lib/growth/import/pipeline"
...
export async function POST(
  ...
  try {
    const result = await runGrowthImportDryRun(access.admin, batchId, parsed.data.columnMapping, {
    ...
    return NextResponse.json({ error: "dry_run_failed", message }, { status: 500 })
  }
}
