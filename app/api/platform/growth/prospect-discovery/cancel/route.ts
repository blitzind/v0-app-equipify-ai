...
import { cancelProspectDiscoveryExecution } from "@/lib/growth/prospect-discovery/prospect-execution-runner"
...
export async function POST(request: Request) {
  ...
  const result = await cancelProspectDiscoveryExecution(access.admin, execution_run_id)
