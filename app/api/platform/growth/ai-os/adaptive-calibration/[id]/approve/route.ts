...
import { approveAdaptiveCalibrationProposal } from "@/lib/growth/aios/learning/growth-adaptive-calibration-service"
import {
...
export async function POST(request: Request, context: RouteContext) {
  ...
  const result = await approveAdaptiveCalibrationProposal(access.admin, {
    organizationId,
    proposalId: id.trim(),
