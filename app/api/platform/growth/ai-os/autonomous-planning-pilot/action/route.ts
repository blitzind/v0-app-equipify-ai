...
/** GE-AIOS-GROWTH-5D — Pilot control writes are owned by Growth Autonomy only. */
  ...
  return NextResponse.json(
    {
      ...
      message: "Planning pilot control is configured in Growth Autonomy — this endpoint is read-only.",
