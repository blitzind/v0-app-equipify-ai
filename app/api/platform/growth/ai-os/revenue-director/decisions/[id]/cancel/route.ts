...
import { cancelRevenueDirectorDecision } from "@/lib/growth/aios/revenue-director/growth-revenue-director-decision-service"
import {
...
export async function POST(request: Request, context: RouteContext) {
  ...
  const result = await cancelRevenueDirectorDecision(access.admin, {
    organizationId,
    decisionId: id.trim(),
