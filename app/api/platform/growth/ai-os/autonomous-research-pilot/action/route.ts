...
/** GE-AIOS-CONSOLIDATION-1E — Pilot control writes are owned by Growth Autonomy only. */
  ...
  return NextResponse.json(
    {
      ...
      message: "Research pilot control is configured in Growth Autonomy — this endpoint is read-only.",
