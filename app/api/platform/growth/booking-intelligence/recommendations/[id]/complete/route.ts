...
import { completeBookingRecommendation } from "@/lib/growth/booking-intelligence/booking-events"
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const recommendation = await completeBookingRecommendation(access.admin, {
      recommendationId: id,
    ...
    return NextResponse.json({
      ...
      message: "Completion recorded — confirms manual booking or deferred follow-up.",
    })
  } catch (error) {
