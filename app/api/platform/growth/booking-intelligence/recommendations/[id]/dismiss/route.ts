...
import { dismissBookingRecommendation } from "@/lib/growth/booking-intelligence/booking-events"
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const recommendation = await dismissBookingRecommendation(access.admin, {
      recommendationId: id,
