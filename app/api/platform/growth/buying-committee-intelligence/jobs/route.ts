...
import {
  GROWTH_BUYING_COMMITTEE_INTELLIGENCE_JOB_MIGRATION,
...
const EnqueueSchema = z.object({
  ...
  trigger_source: z
    .enum(["manual", "company_intelligence_completed", "browser_extension", "infrastructure_panel"])
    .optional(),
})
    ...
    return NextResponse.json(
      {
        ...
        migration: GROWTH_BUYING_COMMITTEE_INTELLIGENCE_JOB_MIGRATION,
      },
      { status: 503 },
    )
  }
