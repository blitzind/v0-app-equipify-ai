...
import { aggregateCommunicationAutomations } from "@/lib/communications/aggregate-automations"
...
export async function GET(
  ...
  const automations = await aggregateCommunicationAutomations(supabase, organizationId)
