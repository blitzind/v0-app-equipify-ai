...
function recommendationsDegradedResponse(message: string) {
  return NextResponse.json(
    {
      ...
      visibleCategories: [] as RecommendationCategory[],
      role: null,
      canDismiss: false,
      canCommand: false,
    },
...
export async function GET(
  ...
  try {
    ...
    console.error("[ai-ops/recommendations] GET failed", e)
    return recommendationsDegradedResponse(
      "Recommendations could not be loaded. Other workspace actions are unaffected.",
    )
  }
}
