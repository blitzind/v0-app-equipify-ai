...
async function main(): Promise<void> {
  ...
  const guardrailConfigKeys = [
    ...Object.keys(GROWTH_RUNTIME_DAILY_BUDGET_CAPS),
    ...Object.keys(GROWTH_RUNTIME_DEFAULT_KILL_SWITCHES),
  ].join("\n")
  assert.match(guardrailConfigKeys, /audience_diffs/)
  assert.match(guardrailConfigKeys, /media_assets/)
  assert.match(guardrailConfigKeys, /landing_pages/)
  assert.match(guardrailConfigKeys, /video_events/)
  assert.match(guardrailConfigKeys, /media_assets_enabled/)
  assert.match(guardrailConfigKeys, /booking_tracking_enabled/)
  assert.match(guardrailConfigKeys, /audience_lead_creations/)
  assert.match(guardrailConfigKeys, /audience_enrollment_previews/)
  assert.match(guardrailConfigKeys, /audience_enrollments/)
  assert.match(guardrailConfigKeys, /audience_diff_enabled/)
  assert.match(guardrailConfigKeys, /audience_lead_creation_enabled/)
  assert.match(guardrailConfigKeys, /audience_preview_enabled/)
  assert.match(guardrailConfigKeys, /audience_enrollment_enabled/)
  assert.match(guardrailConfigKeys, /sendr_page_links/)
  assert.match(guardrailConfigKeys, /sendr_url_resolutions/)
  assert.match(guardrailConfigKeys, /sendr_timeline_events/)
  assert.match(guardrailConfigKeys, /sendr_sequence_bridge_enabled/)
  assert.match(guardrailConfigKeys, /sendr_timeline_enabled/)
  ...
  assert.match(guardrailConfigKeys, /sendr_intelligence/)
  assert.match(guardrailConfigKeys, /sendr_recommendations/)
  assert.match(guardrailConfigKeys, /sendr_timeline_updates/)
  assert.match(guardrailConfigKeys, /sendr_intelligence_enabled/)
  assert.match(guardrailConfigKeys, /sendr_recommendations_enabled/)
  assert.match(guardrailConfigKeys, /sendr_launches/)
  assert.match(guardrailConfigKeys, /sendr_launch_previews/)
  assert.match(guardrailConfigKeys, /sendr_launch_enabled/)
  assert.match(guardrailConfigKeys, /sendr_launch_preview_enabled/)
  assert.match(guardrailConfigKeys, /sendr_analytics/)
  assert.match(guardrailConfigKeys, /sendr_dashboard_refreshes/)
  assert.match(guardrailConfigKeys, /sendr_analytics_enabled/)
  assert.match(guardrailConfigKeys, /sendr_activity/)
  assert.match(guardrailConfigKeys, /sendr_activity_refreshes/)
  assert.match(guardrailConfigKeys, /sendr_activity_enabled/)
