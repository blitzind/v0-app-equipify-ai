...
assert.match(dashboardSource, /GrowthHomeAvaHeroSection/)
assert.match(dashboardSource, /hero=\{avaHero\}/)
...
assert.match(dashboardSource, /GrowthHomeCollapsibleSection[\s\S]*GrowthHomeBusinessSnapshotSection/)
...
assert.match(heroSource, /data-qa-marker=\{hero\.qaMarker\}/)
