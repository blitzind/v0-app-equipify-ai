...
assert.match(dashboard, /homeSimplificationMode|operator-work-details/)
assert.match(dashboard, /GROWTH_HOME_SIMPLIFICATION_1A_QA_MARKER|operator-work-details/)
