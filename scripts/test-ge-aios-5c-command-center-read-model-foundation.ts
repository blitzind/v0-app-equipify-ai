...
assert.ok(service.includes("getRuntimeKillSwitchStates"))
...
assert.ok(panel.includes('qaSection="executive-summary"'))
assert.ok(panel.includes('qaSection="active-missions"'))
assert.ok(panel.includes('qaSection="needs-attention"'))
assert.ok(panel.includes('qaSection="recent-activity"'))
assert.ok(panel.includes('qaSection="agent-health"'))
assert.ok(panel.includes('qaSection="provider-health"'))
assert.ok(panel.includes('qaSection="pilot-status"'))
assert.ok(panel.includes('qaSection="safe-mode"'))
assert.ok(panel.includes("Mission Planning Review"))
