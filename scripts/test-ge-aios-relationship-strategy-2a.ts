...
assert.ok(draftServiceSource.includes("resolveCanonicalHumanMemoryForLead"))
assert.ok(readSource("lib/growth/lead-memory/resolve-canonical-human-memory-for-lead.ts").includes("fetchLeadMemoryProfileView"))
