...
assert.match(schedulerSource, /allowGeneration:\s*false/)
assert.match(schedulerSource, /portfolioSelected:\s*false/)
assert.match(schedulerSource, /draft_factory_admission_reconcile_batch/)
console.log("  ✓ scheduler uses named limit and safe advance options")
