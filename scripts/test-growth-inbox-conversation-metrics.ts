...
function runAudit(): void {
  ...
  assert.doesNotMatch(overviewPanel, /useGrowthConversationsDashboard/)
  assert.doesNotMatch(overviewPanel, /Conversation Intelligence/)
  ...
  assert.match(workflowSummary, /growthWorkspaceConversationsHref/)
  assert.match(workflowSummary, /Conversation metrics unavailable/)
  assert.doesNotMatch(workflowSummary, /\/growth\/replies/)
  console.log("  ✓ workflow intelligence summary surfaces conversation metrics with non-blocking fallback")
