...
assert.match(manifestSource, /"version": "4.3.2"/)
...
assert.match(linkedinCrmOverlayJs, /equipify-sales-linkedin-badge-host/)
...
assert.match(inpageSidebarHtml, /Connect an enrichment provider to find email\/phone/)
...
assert.match(extensionWorkspaceJs, /Connect an enrichment provider to find email\/phone/)
