/**
 * Regression checks for Growth Engine sidebar navigation polish (growth-sidebar-nav-v2 + IA v2).
...
const callsGroup = GROWTH_NAV_GROUP_DEFS.find((g) => g.id === "calls-coaching")
assert.equal(callsGroup?.label, "Calls & Coaching")
