/**
 * AVA-SUPERVISED-CUTOVER-1A — Focused certification (no GPT).
 * Run: pnpm test:ava-supervised-cutover-1a
 */
...
async function main(): Promise<void> {
  console.log(`[${AVA_SUPERVISED_CUTOVER_1A_QA_MARKER}] focused certification`)
