...
function main(): void {
  ...
  assert.match(observability, /activityLoadsToday/)
  assert.match(observability, /feedRefreshesToday/)
  ...
  assert.match(dashboard, /Activity loads today/)
  assert.match(dashboard, /Feed refreshes today/)
