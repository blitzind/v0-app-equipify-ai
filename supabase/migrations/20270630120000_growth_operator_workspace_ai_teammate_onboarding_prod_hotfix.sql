-- PROD-HOTFIX — GE-AI-UX-3B schema missing on production (org table + onboarding column).
-- Idempotent; safe if 20270829120000_growth_organization_ai_teammate_identity_3b.sql already applied.
