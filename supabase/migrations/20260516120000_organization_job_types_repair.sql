-- Idempotent repair: ensures `organization_job_types` exists and defaults are seeded.
-- Safe when `20260511120000_organization_job_types.sql` already ran (repeat DDL is no-op).
-- Use when a remote DB skipped the earlier migration or schema cache was stale.
