-- Technician roster fields: contact + per-org job details (mirrors Add Technician form).
...
-- Lets technicians update their own roster row (job title, region, skills, etc.) without touching org role.
