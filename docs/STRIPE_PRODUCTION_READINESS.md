...
- [ ] **Phase 7A architecture:** [BLITZPAY_PHASE_7_ARCHITECTURE.md](./BLITZPAY_PHASE_7_ARCHITECTURE.md) — nesting caps, entitlement hooks, operational readiness boundaries.
