...
- **Reporting:** `fetchBlitzpayOrgReportingSnapshot` supports `skipClaimsWarranty` on nested linked-org / health-style fetches to cap extra reads; treat Phase **5C** enrichers like other bounded snapshot modules.
