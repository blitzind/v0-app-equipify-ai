...
export function AidenDailyBriefingPanel({ className }: AidenDailyBriefingPanelProps) {
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" variant="ghost" disabled={loading} onClick={() => void load()} aria-label="Refresh briefing">
