...
export function GrowthInboxWorkspaceShell({
  ...
  return (
    ...
    >
      <section
        className="flex min-h-0 w-full shrink-0 flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm lg:w-[24%]"
        aria-label="Thread queue"
      >
        {threadQueue}
      </section>
      <section
        className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-xl border border-border bg-card shadow-md lg:w-[52%] lg:flex-[0_0_52%]"
