...
import { growthAvaRecommendsOutcomeCopy } from "@/lib/growth/workspace/growth-workspace-ava-identity"
  ...
  return (
    <section id="top-business-move" data-qa-section="operator-top-business-move" className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">{growthAvaRecommendsOutcomeCopy(teammate)}</p>
      </div>
