  ...
  return (
    <div className="flex flex-col gap-8" data-qa-marker={GROWTH_DELIVERY_SETTINGS_QA_MARKER}>
      <GrowthWorkspacePageHeader
        ...
        description="Connect mailboxes, manage senders, and confirm delivery readiness before outbound execution."
        icon={Truck}
      ...
      <section id="mailbox-oauth" className="space-y-4">
        ...
        <GrowthProviderSetupDashboard
          variant="operator"
          oauthReturnTo={GROWTH_DELIVERY_SETTINGS_PATH}
        />
      </section>

      <section id={GROWTH_DELIVERY_SETTINGS_CONNECTED_MAILBOXES_ANCHOR.slice(1)} className="space-y-4">
        <div>
        ...
        <GrowthConnectedMailboxesDashboard oauthReturnTo={GROWTH_DELIVERY_SETTINGS_PATH} />
      </section>

      <GrowthEngineCard title="Sender & DNS">
