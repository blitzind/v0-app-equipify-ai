    ...
    <Card className="border-primary/20 bg-gradient-to-br from-primary/[0.06] to-transparent lg:hidden">
      <CardContent className="p-4 flex items-center gap-3">
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center justify-center gap-1 rounded-xl bg-primary px-4 py-2.5 min-h-11 text-xs font-semibold text-primary-foreground shadow-sm touch-manipulation active:opacity-90"
        >
          Open
